...
import GetFlatTypeNameCmb from "../scripts/GetFlatTypeNameCmb";
import GetProjectNameCmb from "../scripts/GetProjectNameCmb";
import GetFlatStatusNameCmb from "../scripts/GetFlatStatusNameCmb";
import { useState } from "react";
import myLink from "../scripts/Links";
import axios from "axios";


function FormDaireContainer() {
  ...
  const btnSave = async () => {
    let request = {
      ...
      ProjectID: projectID,
      FlatTypeID: flatType,
      FlatStatusID: flatStatus,
      Price: price,
    };

    const response = await axios.post(myLink.postFlatLink, request);
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              <li>
                <Link to="#">Proje Yönetimi</Link>
                <i className="fa fa-circle" />
              </li>
              <li>
                <Link to="/FormDaire">Daire</Link>
                <i className="fa fa-circle" />
              </li>
                    ...
                    <form role="form">
                      <div className="form-body">
                        ...
                        <div className="form-group">
                          ...
                          <GetFlatStatusNameCmb
                            setFlatStatus={setFlatStatus}
...
export default FormDaireContainer;
