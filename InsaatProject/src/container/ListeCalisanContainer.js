...
import GetEmployeeList from "../scripts/GetEmployeeList";

function ListeCalisanContainer() {
  return (
    <div>
      {/* 
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <Link to="/ListeCalisan">Çalışan</Link>
                <i className="fa fa-circle" />
              </li>
...
export default ListeCalisanContainer;
