...
import GetFlatTypeList from "../scripts/GetFlatTypeList";

function ListeDaireTipiContainer() {
  return (
    <div>
      {/* END HEADER */}
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <Link to="/ListeDaireTipi">Daire Tipi</Link>
                <i className="fa fa-circle" />
              </li>
...
export default ListeDaireTipiContainer;
