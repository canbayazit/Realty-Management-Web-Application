...
import GetCustomerList from "../scripts/GetCustomerList";

function ListeMusteriContainer() {
  return (
    <div>
      {/* END HEADER */}
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <Link to="/ListeMusteri">Müşteri</Link>
                <i className="fa fa-circle" />
              </li>
...
export default ListeMusteriContainer;
