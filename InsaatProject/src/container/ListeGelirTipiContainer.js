...
import GetIncomeTypeList from "../scripts/GetIncomeTypeList";

function ListeGelirTipiContainer() {
  return (
    <div>
      {/* 
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <Link to="/ListeGelirTipi">Gelir Tipi</Link>
                <i className="fa fa-circle" />
              </li>
...
export default ListeGelirTipiContainer;
