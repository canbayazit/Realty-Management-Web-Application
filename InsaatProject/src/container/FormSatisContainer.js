...
import GetEmployeeNameCmb from "../scripts/GetEmployeeNameCmb";
import GetFlatNoCmb from "../scripts/GetFlatNoCmb";
import myLink from "../scripts/Links";

function FormSatisContainer() {
  ...
  const btnSave = async () => {
    ...
    const response = await axios.post(myLink.postSaleLink, request);
                    ...
                    <form role="form">
                      <div className="form-body">
                        ...
                        <div className="form-group">
                          ...
                          <GetFlatNoCmb setFlatNo={setFlatNo} flatNo={flatNo} />
                        </div>
                        <div className="form-group">
                          <label>Fiyat</label>
                          <input
...
export default FormSatisContainer;
