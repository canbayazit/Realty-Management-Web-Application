...
import GetProjectStatusNameCmb from "../scripts/GetProjectStatusNameCmb";
import myLink from "../scripts/Links";

function FormProjeContainer() {
  ...
  const btnSave = async () => {
    ...
    const response = await axios.post(myLink.postProjectLink, request);
...
export default FormProjeContainer;
