...
import GetProjectStatusList from "../scripts/GetProjectStatusList";

function ListeProjeDurumuContainer() {
  return (
    <div>
      {/* END HEADER */}
        ...
        <div className="page-content">
          <div className="container">
            ...
            <ul className="page-breadcrumb breadcrumb">
              ...
              <li>
                <Link to="/ListeProjeDurumu">Proje Durumu</Link>
                <i className="fa fa-circle" />
              </li>
...
export default ListeProjeDurumuContainer;
